...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_planck_grid(
    TD(DANCE_0),    TD(DANCE_1),       TD(DANCE_2),       KC_P,              KC_Y,           KC_TRANSPARENT, KC_TRANSPARENT, KC_F,           KC_G,           KC_C,           KC_R,           KC_L,
    KC_A,           MT(MOD_LCTL, KC_O),MT(MOD_LALT, KC_E),MT(MOD_LGUI, KC_U),KC_I,           KC_TRANSPARENT, KC_TRANSPARENT, KC_D,           MT(MOD_RGUI, KC_H),MT(MOD_RALT, KC_T),MT(MOD_RCTL, KC_N),KC_S,
    TD(DANCE_3),    KC_Q,              KC_J,              KC_K,              KC_X,           KC_TRANSPARENT, KC_TRANSPARENT, KC_B,           KC_M,           KC_W,           KC_V,           KC_Z,
    KC_TRANSPARENT, KC_TRANSPARENT,    KC_TRANSPARENT,    KC_SPACE,          OSM(MOD_LSFT),  KC_TRANSPARENT, KC_TRANSPARENT, KC_BSPACE,      TO(1),          KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT
  ),

  [_RAISE] = LAYOUT_planck_grid(
    KC_ESCAPE,      KC_AT,          KC_HASH,        TD(DANCE_4),    KC_PERC,        KC_TRANSPARENT, KC_TRANSPARENT, KC_CIRC,        KC_AMPR,        KC_ASTR,        TD(DANCE_5),    KC_BSPACE,
    KC_TAB,         KC_EQUAL,       KC_TRANSPARENT, KC_TRANSPARENT, KC_QUOTE,       KC_TRANSPARENT, KC_TRANSPARENT, TD(DANCE_6),    KC_LCBR,        KC_RCBR,        TD(DANCE_7),    KC_ENTER,
    KC_TILD,        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_DQUO,        KC_TRANSPARENT, KC_TRANSPARENT, KC_LBRACKET,    KC_LPRN,        KC_RPRN,        KC_RBRACKET,    TO(3),
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, TO(0),          OSM(MOD_LSFT),  KC_TRANSPARENT, KC_TRANSPARENT, KC_RALT,        TO(2),          KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT
  ),

  [_LAYER4] = LAYOUT_planck_grid(
    KC_ESCAPE,      KC_TRANSPARENT, KC_TRANSPARENT,     KC_TRANSPARENT,   KC_UNDS, KC_TRANSPARENT, KC_TRANSPARENT, TD(DANCE_F12), TD(DANCE_F7), TD(DANCE_F8), TD(DANCE_F9),          KC_BSPACE,
    KC_TAB,         KC_TRANSPARENT, KC_AUDIO_VOL_DOWN,  KC_AUDIO_VOL_UP,  KC_PLUS, KC_TRANSPARENT, KC_TRANSPARENT, TD(DANCE_F11), TD(DANCE_F4), TD(DANCE_F5), TD(DANCE_F6),          KC_ENTER,
    RESET,          KC_ASTR,        KC_BRIGHTNESS_DOWN, KC_BRIGHTNESS_UP, KC_DOT,  KC_TRANSPARENT, KC_TRANSPARENT, TD(DANCE_F10), TD(DANCE_F1), TD(DANCE_F2), TD(DANCE_F3),          KC_TRANSPARENT,
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,     TO(0),            KC_LGUI, KC_TRANSPARENT, KC_TRANSPARENT, KC_RALT,        KC_NO,          KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT
  ),

  [_LAYER5] = LAYOUT_planck_grid(
    TD(DANCE_8),    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, TD(DANCE_9),            KC_TRANSPARENT, KC_TRANSPARENT, LGUI(KC_LBRACKET), LCTL(LSFT(KC_TAB)),    LCTL(KC_TAB),        LGUI(KC_RBRACKET), KC_BSPACE,
    TD(DANCE_10),   KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, MT(MOD_LGUI,KC_DELETE), KC_TRANSPARENT, KC_TRANSPARENT, TD(DANCE_11),      MT(MOD_LGUI, KC_DOWN), MT(MOD_LALT, KC_UP), TD(DANCE_12),      KC_ENTER,
    TD(DANCE_13),   KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,         KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,    KC_TRANSPARENT,        KC_TRANSPARENT,      KC_TRANSPARENT,    KC_TRANSPARENT,
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, TO(0),          KC_TRANSPARENT,         KC_TRANSPARENT, KC_TRANSPARENT, KC_RALT,           TO(1),                 KC_TRANSPARENT,      KC_TRANSPARENT,    KC_TRANSPARENT
  ),
...
void dance_f11_finished(qk_tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[24].step) {
        case SINGLE_TAP: register_code16(KC_EQL); break;
        case SINGLE_HOLD: register_code16(KC_F11); break;
        case DOUBLE_TAP: register_code16(KC_EQL); register_code16(KC_EQL); break;
        case DOUBLE_SINGLE_TAP: tap_code16(KC_EQL); register_code16(KC_EQL);
    }
}
...
void dance_f11_reset(qk_tap_dance_state_t *state, void *user_data) {
    wait_ms(10);
    switch (dance_state[24].step) {
        case SINGLE_TAP: unregister_code16(KC_EQL); break;
        case SINGLE_HOLD: unregister_code16(KC_F11); break;
        case DOUBLE_TAP: unregister_code16(KC_EQL); break;
        case DOUBLE_SINGLE_TAP: unregister_code16(KC_EQL); break;
    }
    dance_state[24].step = -1;
}
...
void dance_f12_finished(qk_tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[25].step) {
        ...
        case DOUBLE_TAP: register_code16(KC_MINS); register_code16(KC_MINS); break;
