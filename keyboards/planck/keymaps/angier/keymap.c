...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LAYER5] = LAYOUT_planck_grid(
    ...
    TD(DANCE_10),   KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_DELETE,      KC_TRANSPARENT, KC_TRANSPARENT, TD(DANCE_11),   MT(MOD_LGUI, KC_DOWN),MT(MOD_LALT, KC_UP),TD(DANCE_12),   KC_ENTER,
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, TO(0),          KC_LSHIFT,      KC_TRANSPARENT, KC_NO,          KC_RALT,        TO(2),          KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT
  ),
