...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_planck_grid(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, OSM(MOD_LSFT),  KC_BSPACE,      KC_TRANSPARENT, KC_NO,          KC_SPACE,       TO(1),          KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT
  ),
  ...
  [_RAISE] = LAYOUT_planck_grid(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, TO(0),          OSM(MOD_LSFT),  KC_TRANSPARENT, KC_NO,          KC_TRANSPARENT, TO(2),          KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT
  ),
  ...
  [_LAYER4] = LAYOUT_planck_grid(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, TO(0),          KC_LGUI,      KC_TRANSPARENT, KC_NO,          KC_RALT,        KC_NO,          KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT
  ),
  ...
  [_LAYER5] = LAYOUT_planck_grid(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, TO(0),          KC_TRANSPARENT, KC_TRANSPARENT, KC_NO,          KC_RALT,        TO(1),          KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT
  ),
